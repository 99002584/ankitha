...
//                fAuth.signOut();
            database.getReference("Advertiser").addValueEventListener(new ValueEventListener() {
                    @Override
                ...
                database.getReference("Influencer").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.child(currentUser.getUid()).exists())
                        {
